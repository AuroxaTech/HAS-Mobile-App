...
class MyServiceRequestDetailController extends GetxController{
  ...
  Rx<CalendarData?> getServiceOne = Rx<CalendarData?>(null);
  RxInt id = 0.obs;
  @override
  void onInit() {
    ...
    try {
      ...
      if (result['data'] != null) {
        if (result['data'] is Map) {
          ...
          print("Data :: $data");
          getServiceOne.value = CalendarData.fromJson(data);
          String imagesString = getServiceOne.value!.request.service!.media.toString();
