...
class NewServiceRequestScreen extends GetView<NewServiceRequestScreenController> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: homeAppBar(context, text: "New Service Requests",),
      body: SafeArea(
        child: Padding(
                ...
                children: [
                 ...
                 ListTile(
                   leading:  CircleAvatar(
                     radius: 30,
                     backgroundImage: NetworkImage(AppUrls.mediaImages + controller.data[5]),
                   ),
                   title: customText(
                  ...
                  CustomTextField(
                    ...
                    validator:  (value) =>
                    emailValidation(controller.emailController.text) ? null : 'Email is incorrect',
                  ),
                            ...
                            onTap: (){
                              if(controller.formKey.currentState!.validate()){
                                controller.newServiceRequest(
                                    ...
                                    serviceProviderId: controller.data[3].toString(),
                                    ...
                                    additionalInfo: controller.instructionController.text.isEmpty ?"" : controller.instructionController.text);
                                }
