            ...
            children: [
              PageView.builder(
                ...
                itemBuilder: (context, index){
                  ...
                  return InkWell(
                    onTap: (){
                      Get.to(() => ViewImage(photo: AppUrls.mediaImages + image,), transition: routeTransition);
                    },
              ...
              Positioned(child:   Padding(
                ...
                child: Row(
                  ...
                  children: [
                    ...
                    InkWell(
                      onTap: (){
                        Get.toNamed(kEditServiceScreen, arguments: controller.getServiceOne.value!.id);
              ...
              Positioned(child:  Padding(
                padding:  EdgeInsets.only(top: screenHeight(context) * 0.45),
                child: Align(
                                            ...
                                            children: [
                                                ...
                                                children: [
                                                  Column(
                                                    ...
                                                    children: [
                                                      ...
                                                      customText(
                                                          text: controller.getServiceOne.value!.user!.fullname.toString(),
                                                          color: blackColor,
                                                          fontSize: 16
                                                      ),
                                                    ],
                                                  ...
                                                  Column(
                                                    ...
                                                    children: [
                                                      ...
                                                      customText(
                                                          text: controller.getServiceOne.value!.user!.email.toString(),
                                                          color: blackColor,
                                                          fontSize: 16
                                                      ),
                                                    ],
                                                ...
                                                children: [
                                                  Row(
                                                    children: [
                                                      ...
                                                      customText(
                                                          text: " Duration : ${controller.getServiceOne.value!.startTime}",
                                                          color: greyColor,
                                                          fontSize: 15
                                                      ) ,
                                                    ],
                                              ...
                                              Row(
                                                children: [
                                                  ...
                                                  customText(
                                                      text: " Service Area : ${controller.getServiceOne.value!.location}",
                                                      color: greyColor,
                                                      fontSize: 16
                                                  ) ,
                                                ],
                                                      ...
                                                      onTap: (){
                                                        animatedDialog(context,
                                                            ...
                                                            yesTap: (){
                                                              ...
                                                              Navigator.pop(context);
                                                              controller.deleteService(id: controller.idService.value);
                                                            },
                                                            cancelTap: (){
                                                              Navigator.pop(context);
                                                            }
