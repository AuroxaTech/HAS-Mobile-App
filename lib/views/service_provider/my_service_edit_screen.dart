...
class MyServiceEditScreen extends GetView<MyServicesDetailScreenController> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: homeAppBar(context, text: "Service Details",),
      body: SafeArea(
        child: Padding(
                  ...
                  InkWell(
                    ...
                    child: Container(
                      ...
                      child: Row(
                        ...
                        children: [
                          Obx(() => Text(controller.selectedCountry.value ?? 'Select Country', style: GoogleFonts.poppins(color: greyColor, fontWeight: FontWeight.w400, fontSize: 16),)),
                        ...
                        child: CustomButton(
                          ...
                          onTap: ()async{
                            if(controller.formKey.currentState!.validate()){
                              ...
                              if(controller.pickedImages.isEmpty){
                                List<String> fileUrls = controller.getServiceOne.value!.media.split(",");
                                List<File> downloadedFiles = [];

                                for (String url in fileUrls) {
                                  File downloadedFile = await controller.downloadImage(AppUrls.mediaImages + url);
                                  downloadedFiles.add(downloadedFile);
                                }

                                List<XFile> mediaFiles = controller.convertFilesToXFiles(downloadedFiles);
                                ...
                                controller.updateService(
                                  ...
                                  categoryId: controller.categoryController.text,
