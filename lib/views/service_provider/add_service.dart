                    ...
                    InkWell(
                      ...
                      child: Container(
                        ...
                        child: Row(
                          ...
                          children: [
                            Obx(() => Text(controller.selectedCountry.value ??
                                'Select Country', style: GoogleFonts.poppins(color: greyColor, fontWeight: FontWeight.w400, fontSize: 16),)),
                          ...
                          child: CustomButton(
                            ...
                            onTap: ()async{
                              ...
                              if(controller.formKey.currentState!.validate()){
                                if(controller.images.isEmpty){
                                  AppUtils.errorSnackBar("Select images", "Please select at least one media image", backgroundColor: Colors.red);
                                }else{
                                  ...
                                  controller.addService(
                                      ...
                                      lat: 223.33,
                                      long: 32.344,
                                      additionalInformation: controller.additionalInfoController.text.isEmpty ? "" : controller.additionalInfoController.text,
                                      mediaFiles: controller.images,
                                  );
                                }
                               }
...
class _SearchableDropdownState extends State<SearchableDropdown> {
  ...
  void showSearchDialog() {
    ...
    showModalBottomSheet(
      context: context,
      builder: (BuildContext bc) {
        return StatefulBuilder( // This is used to update the modal's state
              ...
              children: <Widget>[
                ...
                Expanded(
                  child: ListView.builder(
                    ...
                    itemBuilder: (context, index) {
                      return ListTile(
                        title: Text(tempSearchList[index]),
                        onTap: () {
                          setState(() {
