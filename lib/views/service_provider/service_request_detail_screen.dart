...
class ServiceRequestDetailScreen extends GetView<ServiceRequestDetailScreenController> {
          ...
          children: [
            PageView.builder(
              ...
              itemBuilder: (context, index){
                String imagesString = controller.getServiceRequestOne.value!.service == null ? "" :  controller.getServiceRequestOne.value!.service!.media.toString();
                List<String> imageList = imagesString.split(',');
                controller.images = imageList;
                return InkWell(
                  onTap: (){
                    Get.to(() => ViewImage(photo: AppUrls.mediaImages + imageList[index],), transition: routeTransition);
                  },
                                  ...
                                  children: [
                                    Column(
                                      ...
                                      children: [
                                        Center(
                                          child: headingText(
                                            text: controller.getServiceRequestOne.value!.service == null ? "" :controller.getServiceRequestOne.value!.service!.serviceName,
                                            fontSize: 24,
                                          ),
                                        ),
                                        h5,
                                        Padding(
                                          ...
                                          child: Column(
                                            ...
                                            children: [
                                                ...
                                                children: [
                                                  Column(
                                                    ...
                                                    children: [
                                                      ...
                                                      customText(
                                                          text:  controller.getServiceRequestOne.value!.provider!.fullname,
                                                          color: blackColor,
                                                          fontSize: 16
                                                      ),
                                                    ],
                                                  ...
                                                  Column(
                                                    ...
                                                    children: [
                                                      ...
                                                      customText(
                                                          text: controller.getServiceRequestOne.value!.provider!.email,
                                                          color: blackColor,
                                                          fontSize: 16
                                                      ),
                                                    ],
                                              ...
                                              h5,
                                              customText(
                                                  text: controller.getServiceRequestOne.value!.description,
                                                  color: blackColor,
                                                  fontSize: 14
                                              ),
                                              h5,
                                                ...
                                                children: [
                                                  Expanded(
                                                    child: Column(
                                                      ...
                                                      children: [
                                                        ...
                                                        h5,
                                                        customText(
                                                            text: controller.getServiceRequestOne.value!.address,
                                                            color: blackColor,
                                                            fontSize: 16
                                                        ),
                                                      ],
                                                  ...
                                                  Column(
                                                    ...
                                                    children: [
                                                      ...
                                                      h5,
                                                     Image.asset(AppIcons.newBanner, height: 25,)
                                                    ],
                                                  ),
                                                ],
                                              ) ,
                                              ...
                                              Row(
                                                children: [
                                                  ...
                                                  w10,
                                                  customText(
                                                      text: controller.getServiceRequestOne.value!.date,
                                                      color: blackColor,
                                                      fontSize: 12
                                                  ),
                                                ],
                                              ...
                                              Row(
                                                children: [
                                                  ...
                                                  w10,
                                                  customText(
                                                      text: controller.getServiceRequestOne.value!.time,
                                                      color: blackColor,
                                                      fontSize: 12
                                                  ),
                                                ],
                                    ...
                                    Padding(
                                      ...
                                      child: Row(
                                        children: [
                                          ...
                                          Expanded(
                                            child: CustomButton(
                                              onTap: controller.getServiceRequestOne.value!.approved == "1" ? null : (){
                                                controller.acceptServiceRequest(
                                                    requestId: controller.getServiceRequestOne.value!.id,
                                                    userId: controller.getServiceRequestOne.value!.user.id.toString(),
                                                    providerId: controller.getServiceRequestOne.value!.provider!.id.toString()).then((value) {
                                                  controller.getServiceRequest(id: controller.id.value);
                                                });
                                              },
                                              height: screenHeight(context) * 0.04,
                                              text: "Accept",
                                              fontSize: 12,
                                              gradientColor: acceptGradient(color:  controller.getServiceRequestOne.value!.approved == "1" ? Color(0xff14C034).withOpacity(0.3) : Color(0xff14C034) ),
                                            ),
                                          ),
                                            ...
                                            child: CustomButton(
                                              onTap: (){
                                                animatedDialog(context,
                                                    ...
                                                    yesTap: (){
                                                      controller.declineServiceRequest(requestId: controller.getServiceRequestOne.value!.id).then((value) {
                                                        controller.getServiceRequest(id: controller.id.value);
                                                      });
                                                    }
                                                );
                                              },
                                              gradientColor: redGradient(color:  controller.getServiceRequestOne.value!.decline == "1" ? redColor.withOpacity(0.3) : redColor ),
                                          ...
                                          Expanded(
                                            child: CustomButton(
                                              onTap: () {
                                                createConversation(controller.getServiceRequestOne.value!.user.fullname, controller.getServiceRequestOne.value!.user.profileimage, controller.getServiceRequestOne.value!.user.id.toString(), context);
                                              },
                                              height: screenHeight(context) * 0.04,
                                              text: "Contact",
                                              fontSize: 12,
