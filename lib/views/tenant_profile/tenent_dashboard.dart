      ...
      body: SafeArea(
        child: Obx(() =>
            RefreshIndicator(
              ...
              child: controller.getTenant.value == null || controller.isLoading.value ?
                ...
                children: [
                  ListTile(
                    leading:  CircleAvatar(
                      radius: 30, // This sets the size of the CircleAvatar
                      ...
                      child: ClipOval(
                        child: CachedNetworkImage(
                          ...
                          height: 60,
                          imageUrl: AppUrls.profileImageBaseUrl +  controller.getTenant.value!.tenant.user.profileimage,
                    ...
                    title: headingText(
                        text: controller.getTenant.value!.tenant.user.fullname,
                        fontSize: 24
                    ),
                    subtitle: customText(
                  ...
                  Container(
                    ...
                    child: Stack(
                      children: [
                        midStackContainer(context, controller.getTenant.value!),
                        Positioned.fill(
                                ...
                                children: [
                                  rowMainAxis(
                                      children: [
                                        dashboardContainer(
                                            onTap: (){
                                              Get.toNamed(kTenantContractScreen);
                                            },
                                            title: "Contracts",
                                        ...
                                        dashboardContainer(
                                          onTap: (){
                                            Get.toNamed(kCurrentRentedScreen);
                                          },
