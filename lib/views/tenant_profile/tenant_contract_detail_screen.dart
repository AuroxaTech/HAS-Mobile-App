                      ...
                      children: [
                        Row(
                          ...
                          children: [
                            ...
                            CircleAvatar(
                              radius: 50,
                              backgroundImage: controller.getContractOne.value!.tenant!.profileimage == "" ? AssetImage(AppIcons.appLogo) : CachedNetworkImageProvider(AppUrls.profileImageBaseUrl + controller.getContractOne.value!.tenant!.profileimage) as ImageProvider,
                            ),
                            // const Icon(
                        ...
                        Center(
                          child: customText(
                            text:  controller.getContractOne.value!.landlordName,
                            fontSize: 20,
                            color: whiteColor,
                          ),
                        ),
                        ...
                        children: [
                          Column(
                            ...
                            children: [
                              ...
                              customText(
                                text: controller.getContractOne.value!.landlord?.email ?? "",
                                color: blackColor,
                                  fontSize: 18,
                                  fontWeight: FontWeight.w500
                              ),
                          ...
                          Builder(
                              builder: (context) {
                                   return customText(
                                  text: controller.getContractOne.value!.includedUtilities,
                                  color: blackColor,
                                       fontSize: 18,
                                       fontWeight: FontWeight.w500
                                );
                          ...
                          Builder(
                              builder: (context) {
                                return customText(
                                  text: controller.getContractOne.value!.tenantResponsibilities,
                                  color: blackColor,
                                    fontSize: 18,
                                    fontWeight: FontWeight.w500
                                );
