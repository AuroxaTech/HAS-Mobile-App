...
class SendPicture extends StatefulWidget {
  ...
  SendPicture({Key? key, required this.userId, required this.data, required this.selectedImages, required this.group}) : super(key: key);
...
class _SendPictureState extends State<SendPicture> {
  ...
  void initState() {
    super.initState();
    sendPicture = widget.selectedImages.isNotEmpty ? widget.selectedImages[0] : File('');
  }
                            ...
                            child: Stack(
                              children: [
                                widget.selectedImages.length < 2
                                  ...
                                  child: Image.file(widget.selectedImages[index], fit: BoxFit.cover),
                                ),
                                widget.selectedImages.length < 2
                                    ? Container()
                                    : Positioned(
                    ...
                    GestureDetector(
                        ...
                        if(messageController.text.isEmpty){
                          ...
                          try {
                            ...
                            for (String imageUrl in uploadedImageUrls) {
                              ...
                              String receiverId = widget.data["user1"] == senderId ? widget.data["user2"] : widget.data["user1"];
                            ...
                            await FirebaseFirestore.instance.collection('conversationListing').doc(widget.data.id).update({
                      ...
                      child: Container(
                        ...
                        decoration: BoxDecoration(
                          ...
                          color: Colors.red,
                          image: const DecorationImage(image: AssetImage('assets/images/send.png')),
                        ),
                      ),
                    ),
                  ],
