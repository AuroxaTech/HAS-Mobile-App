                ...
                child: Column(
                  ...
                  children: [
                    ...
                    CustomTextField(
                      ...
                      errorText: controller.newYorkField.value
                          ? null
                    ...
                    CustomTextField(
                      ...
                      onTap: () async {
                        ...
                        if (result != null) {
                          ...
                          controller.postalAddressController.text =
                    ...
                    CustomButton(
                        ...
                        onTap: () async {
                          if (controller.formKeyDetail.currentState!
                              .validate()) {
                            if (controller.images.length < 5) {
                              AppUtils.errorSnackBar(
                                  "Select Images", "Minimum 5 images required");
                              return;
                            }
                            ...
                            try {
                              ...
                              int nofProp = int.parse(
                                  controller.noOfPropertiesValue.value);
