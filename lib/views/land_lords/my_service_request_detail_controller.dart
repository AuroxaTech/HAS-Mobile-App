...
class MyServiceRequestDetailScreen extends GetView<MyServiceRequestDetailController> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      body: SafeArea(
        ...
        controller.getServiceOne.value == null ? Center(
          child: customText(
            text: "No Data found",
          ),
        ) :  Stack(
          children: [
            PageView.builder(
              ...
              itemBuilder: (context, index){
                String imagesString = controller.getServiceOne.value == null ? "" :  controller.getServiceOne.value!.request.service!.media..toString();
                                  ...
                                  children: [
                                    Column(
                                      ...
                                      children: [
                                        Center(
                                          child: headingText(
                                            text: controller.getServiceOne.value!.request == null ? "" :controller.getServiceOne.value!.request.service!.serviceName,
                                            fontSize: 24,
                                          ),
                                        ),
                                        h5,
                                        Padding(
                                          ...
                                          child: Column(
                                            ...
                                            children: [
                                                ...
                                                children: [
                                                  Column(
                                                    ...
                                                    children: [
                                                      ...
                                                      customText(
                                                          text:  controller.getServiceOne.value!.provider!.fullname,
                                                          color: blackColor,
                                                          fontSize: 16
                                                      ),
                                                    ],
                                                  ...
                                                  Column(
                                                    ...
                                                    children: [
                                                      ...
                                                      customText(
                                                          text: controller.getServiceOne.value!.provider!.email,
                                                          color: blackColor,
                                                          fontSize: 16
                                                      ),
                                                    ],
                                              ...
                                              h5,
                                              customText(
                                                  text: controller.getServiceOne.value!.request.description,
                                                  color: blackColor,
                                                  fontSize: 14
                                              ),
                                              h5,
                                                ...
                                                children: [
                                                  Column(
                                                    ...
                                                    children: [
                                                      ...
                                                      h5,
                                                      customText(
                                                          text: controller.getServiceOne.value!.request.address,
                                                          color: blackColor,
                                                          fontSize: 16
                                                      ),
                                                    ],
                                              ...
                                              Row(
                                                children: [
                                                  ...
                                                  w10,
                                                  customText(
                                                      text: controller.getServiceOne.value!.request.date,
                                                      color: blackColor,
                                                      fontSize: 12
                                                  ),
                                                ],
                                              ...
                                              Row(
                                                children: [
                                                  ...
                                                  w10,
                                                  customText(
                                                      text: controller.getServiceOne.value!.request.time,
                                                      color: blackColor,
                                                      fontSize: 12
                                                  ),
                                                ],
