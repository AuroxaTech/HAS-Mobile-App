                  ...
                  children: [
                    PageView.builder(
                      ...
                      itemBuilder: (context, index) {
                        var imageUrl = controller
                                .getServiceRequestOne.value?.serviceImages[
                            index]; // Get image URL directly from controller.images
                        ...
                        return InkWell(
                          ...
                          child: CachedNetworkImage(
                            ...
                            imageUrl:
                                imageUrl.imagePath, // Load image with base URL
                            fit: BoxFit.cover,
    ...
    return LayoutBuilder(builder: (context, constraints) {
      return DraggableScrollableSheet(
        ...
        builder: (BuildContext context, ScrollController scrollController) {
          Job? jobDetail = controller
              .getServiceRequestOne.value; // Get Job detail from controller
                              ...
                              children: [
                                Column(
                                  ...
                                  children: [
                                    Center(
                                      child: headingText(
                                        text: jobDetail?.serviceName ??
                                            "No Service Name", // Access serviceName directly from Job model
                                        fontSize: 24,
                                      ),
                                    ),
                                    h5,
                                        ...
                                        children: [
                                              ...
                                              Column(
                                                ...
                                                children: [
                                                  ...
                                                  customText(
                                                    text: jobDetail
                                                            ?.user.fullName ??
                                                        "No Name", // Access user.fullName from Job model
                                                    color: blackColor,
                                                    fontSize: 16,
                                                  ),
                                                ],
                                                ...
                                                child: Column(
                                                  ...
                                                  children: [
                                                    ...
                                                    customText(
                                                        text: jobDetail
                                                                ?.user.email ??
                                                            "No Email", // Access user.email from Job model
                                                        color: blackColor,
                                                        fontSize: 16),
                                                  ],
                                                ),
                                          ...
                                          customText(
                                              text: jobDetail?.description ??
                                                  "No Description", // Access description directly from Job model
                                              color: blackColor,
                                              fontSize: 14),
                                          h5,
                                          Row(
                                              ...
                                              Column(
                                                ...
                                                children: [
                                                  ...
                                                  customText(
                                                      text: jobDetail
                                                              ?.location ??
                                                          "", // Access location directly from Job model
                                                      color: blackColor,
                                                      fontSize: 16),
                                                ],
                                              ),
                                          ...
                                          Row(
                                            children: [
                                              ...
                                              w10,
                                              customText(
                                                  text: jobDetail?.startTime ??
                                                      "", // Access startTime directly from Job model, assuming client date is startTime
                                                  color: blackColor,
                                                  fontSize: 12),
                                            ],
                                          ),
                                          Row(
                                            children: [
                                              ...
                                              w10,
                                              customText(
                                                  text: jobDetail?.endTime ??
                                                      "", // Access endTime directly from Job model, assuming client time is endTime
                                                  color: blackColor,
                                                  fontSize: 12),
                                            ],
                                          ),
                                              ...
                                              child: CustomButton(
                                                onTap: () {
                                                  animatedDialog(
                                                    ...
                                                    yesTap: () {
                                                      if (jobDetail != null) {
                                                        controller.prepareForPayment(jobDetail);
                                                        
                                                        Get.off(() => StripePaymentScreen(
                                                          jobId: jobDetail.id,
                                                          id: controller.id.value,
                                                          serviceProviderName: jobDetail.serviceName,
