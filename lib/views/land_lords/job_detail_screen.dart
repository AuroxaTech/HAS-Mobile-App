          ...
          children: [
            PageView.builder(
              ...
              itemBuilder: (context, index){
                String imagesString = controller.getServiceRequestOne.value!.request == null ? "" :  controller.getServiceRequestOne.value!.request.service!.media;
                                  ...
                                  children: [
                                    Column(
                                      ...
                                      children: [
                                        Center(
                                          child: headingText(
                                            text: controller.getServiceRequestOne.value!.request == null ? "" :controller.getServiceRequestOne.value!.request.service!.serviceName,
                                            fontSize: 24,
                                          ),
                                        ),
                                        h5,
                                        Padding(
                                          ...
                                          child: Column(
                                            ...
                                            children: [
                                              ...
                                              h5,
                                              customText(
                                                  text: controller.getServiceRequestOne.value!.request.description,
                                                  color: blackColor,
                                                  fontSize: 14
                                              ),
                                              h5,
                                                ...
                                                children: [
                                                  Column(
                                                    ...
                                                    children: [
                                                      ...
                                                      h5,
                                                      customText(
                                                          text: controller.getServiceRequestOne.value!.request.address,
                                                          color: blackColor,
                                                          fontSize: 16
                                                      ),
                                                    ],
                                              ...
                                              Row(
                                                children: [
                                                  ...
                                                  w10,
                                                  customText(
                                                      text: controller.getServiceRequestOne.value!.request.date,
                                                      color: blackColor,
                                                      fontSize: 12
                                                  ),
                                                ],
                                              ...
                                              Row(
                                                children: [
                                                  ...
                                                  w10,
                                                  customText(
                                                      text: controller.getServiceRequestOne.value!.request.time,
                                                      color: blackColor,
                                                      fontSize: 12
                                                  ),
                                                ],
                                            ...
                                            child: CustomButton(
                                              onTap: (){
                                                animatedDialog(context,
                                                    title: "Job Completed",
                                                    subTitle: "Are you sure to complete this job",
                                                    yesButtonText: "Complete",
                                                    isLoading: controller.isLoading.value,
                                                    yesTap: (){
                                                      controller.acceptServiceRequest(
                                                          jobId: controller.getServiceRequestOne.value!.id,
                                                          status: 1
                                                      ).then((value) {
                                                        controller.getJobRequest(id: controller.id.value);
                                                      });
                                                    }
                                                );
                                              },
