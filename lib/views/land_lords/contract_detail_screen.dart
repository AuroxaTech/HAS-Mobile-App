                            ...
                            child: Column(
                              children: [
                                ...
                                Center(
                                  child: customText(
                                    text: controller
                                        .getContractOne.value!.tenantName,
                                    fontSize: 20,
                                    color: whiteColor,
                                  ),
                                ),
                              ...
                              child: Column(
                                ...
                                children: [
                                  ...
                                  Builder(builder: (context) {
                                    print(controller.getContractOne.value!
                                        .includedUtilities);

                                    String includedUtilitiesJson = controller
                                        .getContractOne
                                        .value!
                                        .includedUtilities;
                                    String includedUtilitiesString;

                                    if (includedUtilitiesJson.startsWith('[') &&
                                        includedUtilitiesJson.endsWith(']')) {
                                      try {
                                        List<dynamic> includedUtilities =
                                            jsonDecode(includedUtilitiesJson);
                                        includedUtilitiesString =
                                  ...
                                  h30,
                                  controller.getContractOne.value!.status == "1"
                                      ? const SizedBox()
                                      : Row(
                                          children: [
                                            Expanded(
