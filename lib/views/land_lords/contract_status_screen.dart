                    ...
                    child: Column(
                      children: [
                          ...
                          children: [
                            ...
                            Expanded(
                              child: topContainer(
                                ...
                                text:
                                    "Approved(${controller.getFilteredContractList('1').length})",
                                textColor: controller.approved.value
                                    ? primaryColor
                                    : greyColor,
                                borderColor: controller.approved.value
                                    ? primaryColor
                                    : greyColor,
                              ),
                            ),
                            ...
                            Expanded(
                              child: topContainer(
                                ...
                                text:
                                    "Pending(${controller.getFilteredContractList('0').length})",
                        ...
                        controller.approved.value
                            ? controller.getFilteredContractList('1').isEmpty
                                ? customText(text: "No Approved contract here")
                                : ListView.builder(
                                    itemCount: controller
                                        .getFilteredContractList('1')
                                        .length,
                                    shrinkWrap: true,
                                    itemBuilder: (context, index) {
                                      Contracts contracts = controller
                                          .getFilteredContractList('1')[index];
                                      ...
                                      return Column(
                                        children: [
                                          ...
                                          InkWell(
                                            onTap: () {
                                              Get.toNamed(kContractDetailScreen,
                                                  arguments: contracts.id);
                                            },
                                            child: Container(
                        ...
                        controller.pending.value
                            ? controller.getFilteredContractList('0').isEmpty
                                ? customText(text: "No Pending contract here")
                                : ListView.builder(
                                    itemCount: controller
                                        .getFilteredContractList('0')
                                        .length,
                                    shrinkWrap: true,
                                    itemBuilder: (context, index) {
                                      Contracts contracts = controller
                                          .getFilteredContractList('0')[index];
                                      print(
                                          "Pending status :${contracts.status}a");
                                      return Column(
                                        children: [
                                          const SizedBox(
                                            height: 15,
                                                          ...
                                                          child: CustomButton(
                                                            ...
                                                            onTap: () {
                                                              animatedDialog(
                                                                  ...
                                                                  yesTap: () {
                                                                print(
                                                                    "Contract Id = ${controller.getContractList[index].id}");
                                                                controller
