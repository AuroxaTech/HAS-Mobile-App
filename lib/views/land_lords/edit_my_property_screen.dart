              ...
              child: Column(
                ...
                children: [
                  ...
                  if (controller.electBill.value == null)
                    ...
                    SizedBox(
                      height: 100,
                      child: fileImage(image: controller.electBill.value!.path, onTap: (){
                    ...
                    onTap: (){
                     if(controller.formKey.currentState!.validate()){
                       if(controller.pickedImages.isEmpty){
                         ...
                         AppUtils.errorSnackBar("Error","Please add electricity image");
                         ...
                         if (controller.home.value) {
                           selectedSubType = controller.getSelectedHomeSubType();
                         } else if (controller.plots.value) {
                           selectedSubType = controller.getSelectedPlotsSubType();
                         } else if (controller.commercial.value) {
                           selectedSubType = controller.getSelectedCommercialSubType();
                         }
                         double? amount = double.tryParse(controller.amountController.text);
                         controller.updateProperty(
                           type: "ccc residential",
                           city: controller.newYorkController.text,
                           amount: amount!,
                           address: controller.streetController.text,
                           lat: 232.43,
                           long: 433.433,
                           areaRange: controller.selectedArea.value.toString(),
                           bedroom: controller.selectedBedroom.value,
                           bathroom: controller.selectedBathrooms.value,
                           electricityBill: controller.electBill.value!,
